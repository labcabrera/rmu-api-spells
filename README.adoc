= RMU Engine Spell API

REST API for RMU spell services.
...
The RMU Engine Spell API provides a RESTful interface for accessing spell data and services related to Rolemaster Unified (RMU). It allows clients to retrieve information about spells, their effects, and other related data.
